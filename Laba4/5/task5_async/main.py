...
class MyForm(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        for edit, url in zip(self.url_edits,
                             (r'https://free-play-online.ru/wp-content/uploads/2018/06/The-Witcher-3-Wild-Hunt-3.jpg',
                              r'https://thumbor.my.ua/3630HPncsNbU4SndSrg4Al-1XEk=/800x432/smart/images.unian.net/photos/2019_11/1574428542-9506.jpg',
                              r'https://as01.epimg.net/meristation/imagenes/2014/06/11/album/1402439100_439100_000001_album_normal.png')):
            edit.setText(url)
